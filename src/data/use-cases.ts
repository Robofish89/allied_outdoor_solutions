...
export const CATEGORY_SECTIONS: CategorySection[] = [
  {
    category: "quick-win",
    label: "Quick Wins",
    tagline: "Deploy in 1-2 weeks — immediate impact on leads, reviews, and response time",
  },
  {
    category: "medium-term",
    label: "Medium-Term Plays",
    tagline: "Build over 1-3 months — smarter sales, deeper CRM intelligence, competitive edge",
  },
  {
    category: "strategic",
    label: "Strategic Initiatives",
    tagline: "Transform over 3-6 months — AI systems that compound value across all 5 markets",
  },
];
...
export const USE_CASES: UseCase[] = [
  // ─── Quick Wins (1-2 Weeks) ────────────────────────────────────────
  {
    ...
    tools: ["OpenAI", "LangChain", "Pinecone", "Next.js API Routes"],
    timeline: "quick-win",
  ...
  // ─── Medium-Term (1-3 Months) ──────────────────────────────────────
  {
    ...
    tools: ["OpenAI", "LangChain", "Pinecone", "Slack Integration"],
  ...
  },
  {
    ...
    tools: ["Apify", "OpenAI", "Clay", "HubSpot/CRM API"],
    timeline: "medium-term",
    timelineLabel: "1-3 Months",
  ...
  },
  {
    ...
    tools: ["OpenAI", "Clay", "Clearbit", "HubSpot/CRM API"],
    timeline: "medium-term",
    timelineLabel: "1-3 Months",
  ...
  },
  {
    ...
    subtitle: "Find luxury homeowners with outdated outdoor spaces",
    description:
      "An AI-powered prospecting engine that identifies high-potential homeowners in luxury neighborhoods — cross-referencing property data, home age, pool permits, and outdoor space satellite imagery to find homes ripe for outdoor living upgrades. Generates personalized outreach at scale.",
    alliedContext:
      "Highland Park in Dallas, River Oaks in Houston, Westlake Hills in Austin, Southlake in Fort Worth — these neighborhoods are full of homes with outdated patios or empty backyards next to expensive pools. This system finds them automatically and crafts outreach referencing their specific property and neighborhood.",
    tools: ["Apify", "OpenAI", "Clay", "Google Maps API", "LinkedIn API"],
    timeline: "strategic",
    timelineLabel: "3-6 Months",
    roi: "Net-new pipeline from luxury neighborhoods, 5-10 qualified leads per week per market",
    processSteps: [
      { label: "Luxury neighborhoods scanned for property and owner data", type: "input" },
      { label: "AI scores properties and crafts personalized outreach", type: "ai" },
      { label: "Qualified prospect list with ready-to-send messages", type: "output" },
    ],
  },
  {
    id: "backyard-vision",
    ...
    tools: ["OpenAI Vision", "Stability AI", "Next.js", "Vercel AI SDK"],
    timeline: "strategic",
    timelineLabel: "3-6 Months",
